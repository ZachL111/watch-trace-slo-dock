...
`watch-trace-slo-dock` is centered on observability work in Scala. The technical target is: Package a Scala local lab for slo analysis with layout fixtures, stable geometry snapshots, and documented operating limits.
